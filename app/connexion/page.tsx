...
const ChoixConnexion = () => {
    return (
        <div className="max-w-screen-auto mx-auto flex h-screen">
            ...
            <div className="w-1/2 bg-blue-900 p-10 flex flex-col items-center justify-center h-screen">
                ...
                <div className='w-96'>
                    ...
                    <Link href={"/connexion/recruteur"}>
                    <Button type='button' title="Connecter a mon compte" variant='btn_blue'/>
                    </Link>
                </div>
                <Link href={"/inscription/recruteur"}><p className='text-gray-400 regular-14 mb-4 mt-10 underline'>Je n'ai pas un compte. s'inscrire</p></Link>
        ...
        <Link href={"/inscription/candidat"}><p className='text-gray-400 regular-14 mb-4 mt-10 underline'>Je n'ai pas un compte. s'inscrire</p></Link>
        </div>
        </div>
      );
}
