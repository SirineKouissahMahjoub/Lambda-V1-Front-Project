...
import illustration from '@/public/Images/illustration3.svg';
      ...
      <div className="w-1/2 p-10 flexCenter bg-white">
        <div className='w-96 flex flex-col justify-center'>
            ...
            <div className='w-96 items-center'>
                ...
                <Link href={"/inscription"}><p className='text-gray-400 regular-14 mb-4 right-0 mt-1 underline'>Je n'ai pas un compte. s'inscrire</p></Link>
