...
interface JobCardExtendedProps {
    id: number;
    logoSrc: string;
    title: string;
    companyName: string;
...
const JobCardExtended: React.FC<JobCardExtendedProps> = ({
    id,
    logoSrc,
    title,
    companyName,
    ...
    return (
        <Link href={`/platform/candidat/jobdetails/${id}`} key={id}>
            <div className="flex items-center mx-2 my-4">
                <div className="bg-white w-[600px] h-[180px] border-[1px] overflow-hidden border-gray-200 hover:shadow-sm rounded-lg relative">
                    ...
                    <div className='relative grid grid-rows-3 grid-flow-col px-4 gap-0'>
                        <div className="grid grid-cols-4 gap-6 left-0 my-4 justify-start">
                        ...
                        <div className="px-8">
                            <div className="grid grid-cols-2 gap-2 mb-2 text-gray-600">
...
export default JobCardExtended;
